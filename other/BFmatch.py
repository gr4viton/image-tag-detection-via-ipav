...
def getTracker():
    ...
    # im = cv2.imread('d:/WORK/2015/2015_09_08 - multikoptera/pyc/tag1.bmp', 0)
...
# img2 = cv2.imread('tag1rot.bmp',0) # trainImage
img2 = cv2.imread('lenaRotSmall.jpg',0) # trainImage
...
cv2.drawMatches(img1,kp1,img2,kp2,matches[:20], img3, flags=1)
